...
use schc_coreconf::{
    ...
    ActiveContext, CoapMessage, CoapOption, Ipv6UdpCoapPacket, LinkRole, PacketReport,
    PreparedContext, ReportDirection, SchcLink, TrafficOrigin, CORE_LOGICAL_ADDRESS,
...
fn duplicate_report_measurements_cover_1_2_3_5_7_overrides() {
    let cases = [
        ...
        (2, &[2, 6][..], 62, 511, 64),
        (3, &[2, 6, 7][..], 85, 695, 87),
        (5, &[2, 6, 7, 8, 9][..], 131, 1063, 133),
        (7, &[2, 6, 7, 8, 9, 10, 11][..], 165, 1335, 167),
    ];
